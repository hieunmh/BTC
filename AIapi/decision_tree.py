...
def train_and_save_model(filename="stock_data.csv"):
    ...
    return clf, scaler, classification_report(y_test, y_pred, zero_division=0)

def load_or_train_model(filename="stock_data.csv"):
    if os.path.exists('models/decision_tree_model.pkl') and os.path.exists('models/scaler.pkl'):
        ...
        clf, scaler, rp = train_and_save_model(filename)
